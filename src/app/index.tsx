...
export default function HomeScreen() {
  ...
  // Fades the bubble in, holds it, then fades it out. Used by both
  // the automatic ambient dialogue and the tap reaction.
  ...
  useEffect(() => {
    // Ambient dialogue now shows itself every 18 seconds instead of 6,
    // so a tap (which is instant) feels clearly different.
